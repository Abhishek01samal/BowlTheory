...
export function CTASection() {
  ...
  return (
    <section className="py-12 w-full flex justify-center items-center px-4 md:px-6">
      ...
      >
        <div className="relative overflow-hidden rounded-[48px] border border-white/20 bg-black/20 backdrop-blur-md shadow-sm min-h-[600px] md:min-h-[600px] flex flex-col items-center justify-center duration-500">
          ...
          <div className="relative z-10 px-6 max-w-4xl mx-auto text-center flex flex-col items-center">
            <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-4 py-1.5 text-sm font-medium text-primary backdrop-blur-sm">
              ...
              Authentic Indo-Chinese Fusion
            </div>

            <h2 className="font-serif text-5xl md:text-7xl lg:text-8xl font-medium tracking-tight text-foreground mb-8 leading-[1.05]">
              Chow Mein, <br />
              <span className="text-gradient-flame">perfectly wok-tossed.</span>
            </h2>

            <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mb-12 leading-relaxed">
              Experience the sizzle of street-side woks. From the bustling lanes of Kolkata to your table —
              crispy noodles, bold spices, unforgettable flavors.
            </p>
